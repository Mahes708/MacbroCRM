    ...
    updateCourse = data =>{       
        axios.get(`http://localhost:4000/Course/${data._id}`).then(res => {  
             this.setState({
                ...
                window.location.href=`/Course_add/?id=${this.state.editData._id}` 
         }) 
    }
                    ...
                    <div className="content-page">
                                                                    ...
                                                                    this.state.data.length > 0 ?
                                                                        ...
                                                                        this.state.data.map((Course, index) =>
                                                                            ...
                                                                            <tr key={Course._id}>
                                                                                ...
                                                                                <td><NumberFormat value={Course.training_fee} displayType={'text'} thousandsGroupStyle="lakh" thousandSeparator={true} prefix={'₹'} /></td>
                                                                                <td>
                                                                                    <a href data-toggle="modal"  onClick={() => this.viewCourse(Course) } data-target="#exampleModal1"> <i className="text-info fa fa-eye" /></a>&nbsp;
                                                                        <a href="" onClick={() => { this.updateCourse(Course) }}><i className=" text-dark fa fa-pencil" aria-hidden="true" /></a>&nbsp;
                        ...
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                                ...
                                <p><label>Training Fees  : </label>&nbsp;<NumberFormat value={this.state.datas.training_fee}  displayType={'text'} thousandsGroupStyle="lakh" thousandSeparator={true} prefix={'₹'} /> </p>
